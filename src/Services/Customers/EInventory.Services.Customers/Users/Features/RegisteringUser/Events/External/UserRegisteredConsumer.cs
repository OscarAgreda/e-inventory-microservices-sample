...
using EInventory.Services.Customers.Customers.Features.CreatingCustomer;
using EInventory.Services.Shared.Identity.Users.Events.Integration;
using MassTransit;

namespace EInventory.Services.Customers.Users.Features.RegisteringUser.Events.External;
