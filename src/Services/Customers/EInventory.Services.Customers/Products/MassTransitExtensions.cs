...
using EInventory.Services.Customers.Products.Features.CreatingProduct.Events.External;
using EInventory.Services.Customers.Products.Features.ReplenishingProductStock.Events.External;
using EInventory.Services.Shared.Catalogs.Products.Events.Integration;

namespace EInventory.Services.Customers.Products;
