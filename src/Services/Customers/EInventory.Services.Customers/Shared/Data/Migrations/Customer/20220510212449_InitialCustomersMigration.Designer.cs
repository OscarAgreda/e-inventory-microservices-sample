...
namespace EInventory.Services.Customers.Shared.Data.Migrations.Customer
{
    ...
    [Migration("20220510212449_InitialCustomersMigration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EInventory.Services.Customers.Customers.Models.Customer", b =>
                {
                    b.Property<long>("Id")
            ...
            modelBuilder.Entity("EInventory.Services.Customers.RestockSubscriptions.Models.Write.RestockSubscription", b =>
                {
                    b.Property<long>("Id")
                        .HasColumnType("bigint")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("EInventory.Services.Customers.Customers.Models.Customer", b =>
                {
                    b.OwnsOne("Ingredients.Core.Domain.ValueObjects.Address", "Address", b1 =>
                        {
                    ...
                    b.OwnsOne("EInventory.Services.Customers.Customers.Models.CustomerName", "Name", b1 =>
                        {
                            b1.Property<long>("CustomerId")
                                .HasColumnType("bigint")
                                .HasColumnName("id");
            ...
            modelBuilder.Entity("EInventory.Services.Customers.RestockSubscriptions.Models.Write.RestockSubscription", b =>
                {
                    b.HasOne("EInventory.Services.Customers.Customers.Models.Customer", null)
                        .WithMany()
                        .HasForeignKey("CustomerId")
                    ...
                    b.OwnsOne("EInventory.Services.Customers.RestockSubscriptions.ValueObjects.ProductInformation", "ProductInformation", b1 =>
                        {
