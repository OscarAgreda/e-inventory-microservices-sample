...
using EInventory.Services.Orders;
using EInventory.Services.Orders.Api.Extensions.ApplicationBuilderExtensions;
using EInventory.Services.Orders.Api.Extensions.ServiceCollectionExtensions;
...
static void RegisterServices(WebApplicationBuilder builder)
{
    ...
    builder.Configuration.AddEnvironmentVariables("einventory_orders_env_");
