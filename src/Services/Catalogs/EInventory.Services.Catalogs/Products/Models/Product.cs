...
using EInventory.Services.Catalogs.Products.Features.ChangingMaxThreshold;
using EInventory.Services.Catalogs.Products.Features.ChangingProductBrand.Events.Domain;
using EInventory.Services.Catalogs.Products.Features.ChangingProductCategory.Events;
using EInventory.Services.Catalogs.Products.Features.ChangingProductPrice;
using EInventory.Services.Catalogs.Products.Features.ChangingProductSupplier.Events;
using EInventory.Services.Catalogs.Products.Features.ChangingRestockThreshold;
...
namespace EInventory.Services.Catalogs.Products.Models;
