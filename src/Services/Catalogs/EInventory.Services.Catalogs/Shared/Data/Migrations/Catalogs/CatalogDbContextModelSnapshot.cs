...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EInventory.Services.Catalogs.Brands.Brand", b =>
                {
                    b.Property<long>("Id")
            ...
            modelBuilder.Entity("EInventory.Services.Catalogs.Categories.Category", b =>
                {
                    b.Property<long>("Id")
                        .HasColumnType("bigint")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("EInventory.Services.Catalogs.Products.Models.Product", b =>
                {
                    b.Property<long>("Id")
                        .HasColumnType("bigint")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("EInventory.Services.Catalogs.Products.Models.ProductImage", b =>
                {
                    b.Property<long>("Id")
                        .HasColumnType("bigint")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("EInventory.Services.Catalogs.Products.Models.ProductView", b =>
                {
                    b.Property<long>("ProductId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("EInventory.Services.Catalogs.Suppliers.Supplier", b =>
                {
                    b.Property<long>("Id")
                        .HasColumnType("bigint")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("EInventory.Services.Catalogs.Products.Models.Product", b =>
                {
                    b.HasOne("EInventory.Services.Catalogs.Brands.Brand", "Brand")
                        .WithMany()
                    ...
                    b.HasOne("EInventory.Services.Catalogs.Categories.Category", "Category")
                        .WithMany()
                    ...
                    b.HasOne("EInventory.Services.Catalogs.Suppliers.Supplier", "Supplier")
                        .WithMany()
                    ...
                    b.OwnsOne("EInventory.Services.Catalogs.Products.ValueObjects.Dimensions", "Dimensions", b1 =>
                        {
                    ...
                    b.OwnsOne("EInventory.Services.Catalogs.Products.ValueObjects.Stock", "Stock", b1 =>
                        {
                            b1.Property<long>("ProductId")
                                .HasColumnType("bigint")
                                .HasColumnName("id");
            ...
            modelBuilder.Entity("EInventory.Services.Catalogs.Products.Models.ProductImage", b =>
                {
                    b.HasOne("EInventory.Services.Catalogs.Products.Models.Product", "Product")
                        .WithMany("Images")
                        .HasForeignKey("ProductId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
...
#pragma warning reeinventory 612, 618
        }
    }
}
