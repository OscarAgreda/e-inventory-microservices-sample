...
using EInventory.Services.Catalogs;
using EInventory.Services.Catalogs.Api.Extensions.ApplicationBuilderExtensions;
using EInventory.Services.Catalogs.Api.Extensions.ServiceCollectionExtensions;
...
static void RegisterServices(WebApplicationBuilder builder)
{
    ...
    builder.Configuration.AddEnvironmentVariables("einventory_catalogs_env_");
