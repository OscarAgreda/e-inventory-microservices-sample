...
namespace EInventory.Services.Identity.Identity.Data;
...
public class IdentityDataSeeder : IDataSeeder
{
    ...
    {
        if (await _userManager.FindByEmailAsync("oscar@test.com") == null)
        {
        ...
        if (await _userManager.FindByEmailAsync("oscar2@test.com") == null)
        {
            var user = new ApplicationUser
            {
                UserName = "oscar2", FirstName = "Oscar", LastName = "Test", Email = "oscar2@test.com"
            };
