    ...
    GenerateRefreshTokenCommandHandler : ICommandHandler<GenerateRefreshTokenCommand, GenerateRefreshTokenCommandResult>
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        {
            var token = global::EInventory.Services.Identity.Shared.Models.RefreshToken.GetRefreshToken();

            refreshToken = new global::EInventory.Services.Identity.Shared.Models.RefreshToken
            {
            ...
            await _context.Set<global::EInventory.Services.Identity.Shared.Models.RefreshToken>().AddAsync(refreshToken, cancellationToken);
        ...
        else
        {
            ...
            _context.Set<global::EInventory.Services.Identity.Shared.Models.RefreshToken>().Update(refreshToken);
            await _context.SaveChangesAsync(cancellationToken);
        }
    ...
    {
        var refreshTokens = _context.Set<global::EInventory.Services.Identity.Shared.Models.RefreshToken>().Where(rt => rt.UserId == userId);
