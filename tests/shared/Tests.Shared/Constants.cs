...
public static class Constants
{
    ...
    public static class Users
    {
        public static class Admin
        {
            ...
            public const string UserName = "oscar";
            public const string Email = "oscar@test.com";
        ...
        public static class User
        {
            ...
            public const string UserName = "oscar2";
            public const string Email = "oscar2@test.com";
            public const string Password = "123456";
